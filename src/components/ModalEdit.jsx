      ...
      <div className="modal">
        <div className="modal-box bg-white border border-b-slate-400">
          ...
          <div className="modal-action">
            {title === "null" || prioritas === "Choose Priority" ? (
              <label className="bg-blue-500 px-6 py-2 rounded-xl cursor-pointer font-semibold" disabled>
                Save
              </label>
            ) : (
              <label className="bg-blue-500 px-6 py-2 rounded-xl hover:bg-blue-600 cursor-pointer font-semibold" htmlFor={props.id} onClick={() => editor(props.id)}>
                Save
              </label>
            )}
          </div>
