    ...
    <>
      <div className="flex justify-between items-center w-full py-12 lg:px-16 px-8">
        ...
        {path === "" ? (
          ...
          <>
            <label htmlFor="">
              <label className="btn bg-sky-500 hover:bg-sky-600 border-none gap-2 h-2 font-semibold text-base normal-case mr-2 px-6 lg:px-5 rounded-full" type="button" data-cy={props.sort} onClick={props.function} htmlFor="mymodal2">
                <span>
